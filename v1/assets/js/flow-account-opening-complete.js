    ...
    steps: [
      {
        ...
        prompt: {
          type: 'text',
          content: '分析：檢視到您的公司業務是拉面店，根據我們的數據分折，在香港一般的餐廳亦會開IG / OpenRice帳號，需要我幫您開嗎？',
          actions: ['ok, openrice']
        },
        routes: [
          {
      ...
      },
      {
        ...
        prompt: {
          type: 'text',
          content: '註冊OpenRice需要您的帳號名、店名、電郵，因您已登入滙豐萬事屋，我可以直接幫您填寫，請問您是否授權並直接提交？',
        ...
        routes: [
          {
            ...
            responses: [
              {
                type: 'text',
                content: '帳號：siubak\n店名：拉王\n電郵：linewong@gmail.com'
              },
              {
                type: 'text',
                content: '成功遞交，如成功批核，您在30分鐘後將會收到確認電郵，確認後可直接從「滙豐萬事屋」直接登入 OpenRice',
                delayMs: 1200
              }
            ],
            clearFlow: true
...
hsbcAccountOpeningCompleteConfig.defaultResponsesByTopic['account-opening-complete'] = [
  {
    type: 'text',
    content: '公司已註冊及開戶已處理完成，因此裝置為您的授權裝置，已直接幫您登入。',
    actions: ['查看您的戶口。']
  }
];
